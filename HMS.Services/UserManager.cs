...
{
    public class UserManager : UserManager<HMSUser>
    {
        public UserManager(IUserStore<HMSUser> store)
           : base(store)
        {
        }
        ...
        {
            var manager = new UserManager(new UserStore<HMSUser>(context.Get<HMSContext>()));
